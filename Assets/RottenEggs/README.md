...
Catch or hit ten times in a row to enter **Fever Mode**. Fever is the existing
3× combo multiplier made visible: your basket gains a pulsing gold frame and a
`FEVER!` HUD callout. Missing a normal egg, or missing a thrown shot in Single,
still resets the streak.
